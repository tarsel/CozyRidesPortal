...
class PermissionTableSeeder extends Seeder
{
    ...
    public function run()
    {
    	...
    	DB::table('permissions')->insert([
            ...
            ['name' => 'advertisement-list', 'display_name' => 'Advertisement List', 'guard_name' => 'admin', 'group_name' => 'Advertisement'],
            ['name' => 'advertisement-create', 'display_name' => 'Create Advertisement', 'guard_name' => 'admin', 'group_name' => 'Advertisement'],
            ['name' => 'advertisement-edit', 'display_name' => 'Edit Advertisement', 'guard_name' => 'admin', 'group_name' => 'Advertisement'],
            ['name' => 'advertisement-delete', 'display_name' => 'Delete Advertisement', 'guard_name' => 'admin', 'group_name' => 'Advertisement'],
