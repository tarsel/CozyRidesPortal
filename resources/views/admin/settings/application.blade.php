				...
				<div class="form-group row">
					...
					<div class="col-xs-9">
						<select name="environment" required id="environment" class="form-control">
							<option <?= (config('constants.environment') == 'development' ? 'selected' : '') ?> value="development">Development</option>
							<option <?= (config('constants.environment') == 'production' ? 'selected' : '')  ?> value="production">Production</option>
						</select>
					</div>
				</div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-8">
                                <select name="currency" class="form-control" required>
									<option @if(config('constants.currency') == "PKR") selected @endif value="PKR">Pakistani rupee</option>
									<option @if(config('constants.currency') == "S/") selected @endif value="S/">America Lima (S/)</option>
