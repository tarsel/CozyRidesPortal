        ...
        <div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="{{route('admin.service.update', $service->id )}}" method="POST" enctype="multipart/form-data" role="form">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <label class="radio-inline"><input value="delivery" {{ ($service->type == "delivery" ? "checked" : "")  }} type="radio" name="type" checked>  Delivery</label>
                        <label class="radio-inline"><input value="ride" {{ ($service->type == "ride" ? "checked" : "")  }} type="radio" name="type">  Ride</label>
                    </div>
                </div>
                <div class="form-group row">
               ...
               <!--  <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-5">
                        <input class="form-control" step="0.01" type="number" value="{{ $service->fixed }}" name="fixed" required id="fixed" placeholder="Base Price" min="0">
                    </div>
                    <div class="col-xs-5">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-5">
                        <input class="form-control" step="0.01" type="number" value="{{ $service->minute }}" name="minute" id="minute" placeholder="Unit Time Pricing" min="0">
                    </div>
                    <div class="col-xs-5">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-5">
                        <input class="form-control" step="0.01" type="number" value="{{ $service->price }}" name="price" id="price" placeholder="Unit Distance Price" min="0">
                    </div>
                    <div class="col-xs-5">
