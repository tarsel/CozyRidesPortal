		...
		<ul class="sidebar-menu">
			...
			<li class="with-sub">
				<a href="#" class="waves-effect  waves-light">
					...
					<span class="s-text">@lang('admin.advertisement.advertisement')</span>
				</a>
				<ul>
					<li><a href="{{ route('admin.advertisement.index') }}">@lang('admin.advertisement.list_advertisement')</a></li>
					<li><a href="{{ route('admin.advertisement.create') }}">@lang('admin.advertisement.add_new_advertisement')</a></li>
				</ul>
			</li>
			@endcan
			@can('documents-list')
			...
			<li class="compact-hide">
				<a href="{{ url('config-cache') }}">
					<span class="s-icon"><i class="ti-power-off"></i></span>
					<span class="s-text">Clear Cache</span>
				</a>
			</li>
