...
class DispatcherList extends React.Component {
    ...
    getTripsUpdate() {
        var SearchTrip  =  $("meta[name='app_url']").attr("content")+'/admin/dispatcher/trips?type=SEARCHING';
        $.get(SearchTrip, function(result) {
...
class DispatcherAssignedList extends React.Component {
    ...
    getTripsUpdate() {
        var ASSIGNEDTrip  =  $("meta[name='app_url']").attr("content")+'/admin/dispatcher/trips?type=ASSIGNED';
        //$.get('/admin/dispatcher/trips?type=ASSIGNED', function(result) {
        $.get(ASSIGNEDTrip, function(result) {
            if(result.hasOwnProperty('data')) {
                this.setState({
                    data: result
                });
...
class DispatcherCancelledList extends React.Component {
    ...
    getTripsUpdate() {
        var CANCELLEDTrip  =  $("meta[name='app_url']").attr("content")+'/admin/dispatcher/trips?type=CANCELLED';
        $.get(CANCELLEDTrip, function(result) {
...
class DispatcherAssignList extends React.Component {
    ...
    componentDidMount() {
        var providers  =  $("meta[name='app_url']").attr("content")+'/admin/dispatcher/providers';
        $.get(providers, {
