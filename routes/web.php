...
Route::get('/send/android/push',
    function(){
        ...
        ->to('fB59rEw6CuY:APA91bGR7aGnPDGnR6DFBzYpcVaIeCM2Kujg97lo0BdLS7-uoIW8NfeoKBNDTT87hnOz1FmKTXLo00NgBpbEMYN4C2ZO-l-WcZaUBtl6AjOEs-lgqQPv7dv7NyBJ6bGqL4G2eJTl2-3z')
        ->send('Hello World, i`m a push message');
            dd($data);
    });
