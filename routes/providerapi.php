...
Route::group(['middleware' => ['provider.api']], function () {
    ...
    Route::post('/stripe-token', 		'Resource\CardResource@set_stripe_client');
    ...
    Route::post('/change/delivery/status' , 	'ProviderResources\TripController@change_delivery_status');
